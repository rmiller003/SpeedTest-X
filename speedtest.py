# This is an Internet Speed Test with a GUI interface designed with Python 3.8
# Written by Robert Miller for RPM Labs 2021
...
bg_image = PhotoImage(file='speedtest.png')
